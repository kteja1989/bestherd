      ...
      <ul class="list-reset lg:flex flex-1 items-center px-4 md:px-0">
        <li class="mr-6 my-2 md:my-0">
          <a href="{{ route('home') }}" class="block py-1 md:py-3 pl-1 align-middle text-blue-400 no-underline hover:text-gray-100 border-b-2 border-blue-400 hover:border-blue-400">
            ...
            <span class="pb-1 md:pb-0 text-sm">Sup-Admin</span>
          </a>
        </li>
        ...
        <li class="mr-6 my-2 md:my-0">
          @if( $controller == 'usageapproval')
            <a href="{{ route('massmail.index') }}" class="block py-1 md:py-3 pl-1 align-middle text-gray-500 no-underline hover:text-gray-100 border-b-2 border-orange-200  hover:border-gray-900">
          @else
            <a href="{{ route('massmail.index') }}" class="block py-1 md:py-3 pl-1 align-middle text-gray-500 no-underline hover:text-gray-100 border-b-2 border-gray-900  hover:border-orange-200">
          @endif
              <i class="fa fa-envelope fa-fw mr-3"></i>
              <span class="pb-1 md:pb-0 text-sm">Mails</span>
            </a>
        </li>

        <li class="mr-6 my-2 md:my-0">
          @if( $controller == 'facility')
            <a href="#" class="block py-1 md:py-3 pl-1 align-middle text-gray-500 no-underline hover:text-gray-100 border-b-2 border-blue-200  hover:border-gray-900">
          @else
            <a href="#" class="block py-1 md:py-3 pl-1 align-middle text-gray-500 no-underline hover:text-gray-100 border-b-2 border-gray-900  hover:border-blue-200">
          @endif
              <i class="fas fa-chart-area fa-fw mr-3"></i>
              <span class="pb-1 md:pb-0 text-sm">Accounts</span>
            </a>
        </li>
        ...
        @hasrole('admin')
          <li class="mr-6 my-2 md:my-0">
            ...
            @endif
                ...
                <span class="pb-1 md:pb-0 text-sm">TBA</span>
              </a>
          </li>
        @endhasrole
        ...
        @hasrole('admin')
          <li class="mr-6 my-2 md:my-0">
            @if( $controller == 'tba')
              <a href="#" class="block py-1 md:py-3 pl-1 align-middle text-gray-500 no-underline hover:text-green-100 border-b-2 border-green-200  hover:border-gray-900">
            @else
              <a href="#" class="block py-1 md:py-3 pl-1 align-middle text-gray-500 no-underline hover:text-gray-100 border-b-2 border-gray-900  hover:border-green-200">
            @endif
                <i class="fas fa-chart-area fa-fw mr-3"></i>
                <span class="pb-1 md:pb-0 text-sm">TBA</span>
              </a>
